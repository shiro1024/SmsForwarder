...
class ToAddressFragment : BaseFragment<FragmentTasksConditionToAddressBinding?>(),
        ...
        val calcType = when (binding!!.rgCalcType.checkedRadioButtonId) {
            R.id.rb_calc_type_distance -> {
                ...
                description = String.format(
                    getString(R.string.to_address_distance_description),
                    longitude,
                    latitude,
                    distance
                )
                ...
                description =
                    String.format(getString(R.string.to_address_keyword_description), address)
                "address"
            }
        }

        val settingVo =
            LocationSetting(description, "to", calcType, longitude, latitude, distance, address)
